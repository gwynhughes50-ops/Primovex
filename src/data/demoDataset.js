...
export const demoStockItems = [
  { id: "stk-001", name: "Hand Sanitiser 500ml", category: "Infection Control", site: "Main Surgery", location: "Treatment Room 1", current_stock: 6, min_stock: 18, reorder_level: 18, unit: "bottles", units_per_box: 12, expiry_date: isoDate(240), supplier_name: "NHS Supply Chain", verificationConfidence: 84, lastVerifiedAt: isoDate(-46), cost: 2.95 },
  { id: "stk-002", name: "Blue Needles 23G", category: "Clinical Consumables", site: "Main Surgery", location: "Treatment Room 2", current_stock: 220, min_stock: 150, reorder_level: 180, unit: "each", units_per_box: 100, expiry_date: isoDate(520), supplier_name: "Medisave", verificationConfidence: 96, lastVerifiedAt: isoDate(-12), cost: 0.03 },
  { id: "stk-003", name: "Gauze Swabs 10x10", category: "Dressings", site: "Main Surgery", location: "Stock Room", current_stock: 18, min_stock: 45, reorder_level: 50, unit: "packs", units_per_box: 5, expiry_date: isoDate(90), supplier_name: "Williams Medical", verificationConfidence: 72, lastVerifiedAt: isoDate(-79), cost: 1.2 },
