    ...
    <div className="space-y-5">
      ...
      <Card className="border border-white/10 bg-slate-900/70 p-5">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-white">MedAI Temperature Note</h2>
        </div>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm text-slate-400">
            Manage integration providers, cloud sync, device onboarding and connections to the shared Device Registry.
          </p>
        </div>
        {canManageDevices && (
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">
                {intelligence.offline.length ? "Device Connectivity Issue" : "Connected Practice Operating Normally"}
              </h2>
