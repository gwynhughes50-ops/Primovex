...
export const ROUTE_MANIFEST = [
  ...
  { path: "/theme-lab", label: "Theme", section: "system", iconKey: "theme", capability: "theme.lab" },
  ...
  { path: "/developer-centre", label: "Developer", section: "developer", iconKey: "developer", developerOnly: true },
