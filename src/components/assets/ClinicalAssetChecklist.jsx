...
<body>
  ...
  return (
    <div className="space-y-5 text-[color:var(--medtrak-text)]">
      ...
      >
        <div className="absolute right-6 top-6 hidden rounded-full border border-[color:var(--medtrak-border)]/80 bg-[color:color-mix(in_srgb,var(--medtrak-bg)_88%,var(--medtrak-panel))] p-8 opacity-40 md:block">
